        ...
        <div class="space-y-6">
          <div
            ...
            <div class="flex items-center gap-3 sm:gap-4">
              <div
                class="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full flex items-center justify-center">
                <img :src="user.avatar ? user.avatar : '/images/trainer/1.png'" :alt="user.username"
          ...
          <div class="space-y-3">
            ...
            <Link v-if="user.role === 'admin'" href="/admin"
                  class="flex items-center gap-3 p-3 rounded-xl hover:bg-error/10 transition-all duration-300 group">
              <div
