...
import type { User, LevelReward, LevelRewardPreview } from '@/types/user';
...
const { user, responsive = false, level_rewards_to_claim = [], level_rewards_preview } = defineProps<Props>();
...
function groupRewardsByLevel(rewards) {
  const grouped = {};
          ...
          <div v-if="level_rewards_to_claim.length > 0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div 
                ...
                :key="`available-${reward.types.join('-')}-${reward.level}`"
              ...
              >
                <div class="flex items-start gap-3">
                  ...
                  <div class="flex-1">
                    ...
                    <Button
                      @click="() => claimReward(reward.level, reward.types[0])"
                      variant="outline"
                      size="sm"
                      class="w-full"
                    >
