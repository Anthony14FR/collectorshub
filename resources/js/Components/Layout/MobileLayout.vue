      ...
      <div class="flex flex-row items-center justify-between overflow-hidden rounded-xl border border-base-300/30 bg-base-100/60 p-4 backdrop-blur-sm relative">
        ...
        <div class="shrink-0 flex justify-center mb-6">
            <div class="scale-75">
                <TrainerProfile
                    :user="user"
                    :trainer-image-id="2"
                    :on-open-pokedex-modal="onOpenTeamManagementModal"
                />
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-4">
            <div
                class="relative h-40 overflow-hidden rounded-xl border border-base-300/30 bg-base-100/60 p-4 flex flex-col justify-end"
                style="
                    background-image: url('/images/background/invocation.png');
            ...
            >
                ...
                <div class="relative z-10">
                    <h3
                        class="mb-1 text-lg font-bold text-white flex items-center"
                    >
                        <img
                            src="/images/items/pokeball.png"
                            alt="pokeball"
                            class="w-6 h-6 mr-2"
                        />
                        Invocation
            ...
            >
                ...
                <div>
                    <h3
                        class="mb-1 bg-gradient-to-r from-info to-info/80 bg-clip-text text-base font-bold text-transparent"
                    >
                        Badges
                    </h3>
                    <p class="text-xs text-base-content/70">
            ...
            <div
                class="bg-base-100/60 backdrop-blur-sm rounded-xl border border-base-300/30 p-4 flex flex-col items-center justify-center text-center space-y-4"
            >
                <div class="flex items-center gap-3">
                    ...
                    <h3
                        class="text-lg font-bold bg-gradient-to-r from-secondary to-accent bg-clip-text text-transparent"
                    >
                        Mon Pokédex
                    </h3>
                </div>
            ...
            <div
                ...
                style="
                    background-image: url('/images/background/leaderboard.jpg');
                    background-size: cover;
                    background-position: center;
                "
            >
                <div
                    class="flex h-full flex-col rounded-[11px] bg-base-100/80 p-4 backdrop-blur-sm"
                >
                    <div class="flex-grow">
