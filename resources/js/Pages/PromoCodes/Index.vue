...
const submitCode = () => {
  form.post('/promocodes/use', {
    ...
    onError: (errors) => {
      ...
      alertMessage.value = Object.values(errors)[0] as string || 'Une erreur est survenue';
    ...
    <div class="relative z-10 h-screen w-screen overflow-y-auto">
      <div class="flex justify-center pt-4 mb-4">
        <div class="text-center">
          <h1 class="text-2xl font-bold bg-gradient-to-r from-success to-primary bg-clip-text text-transparent mb-1 tracking-wider">
            🎟️ CODES PROMO
          </h1>
        ...
        <div class="bg-base-100/60 backdrop-blur-sm rounded-xl border border-base-300/30 overflow-hidden h-full flex flex-col">
          ...
          <div class="flex-1 p-6 overflow-y-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
              <div class="space-y-6">
                <div class="bg-gradient-to-br from-base-200/60 to-base-300/40 backdrop-blur-lg rounded-2xl p-6 border border-success/20">
                  <div class="text-center mb-6">
                    <div class="w-16 h-16 bg-gradient-to-br from-success/20 to-primary/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                <div class="bg-gradient-to-br from-base-200/60 to-base-300/40 backdrop-blur-lg rounded-xl p-4 border border-info/20">
                  ...
                  <p class="text-xs text-base-content/70">
                    Les codes promo vous permettent d'obtenir de l'argent, des objets et d'autres récompenses gratuitement.
                  </p>
                </div>
              </div>

              <div class="space-y-6">
                <div class="bg-gradient-to-br from-base-200/60 to-base-300/40 backdrop-blur-lg rounded-xl p-4 border border-warning/20">
                  <div class="flex items-center gap-3 mb-3">
                ...
                <div class="bg-gradient-to-br from-base-200/60 to-base-300/40 backdrop-blur-lg rounded-xl p-4 border border-accent/20">
                  <div class="flex items-center gap-3 mb-3">
                ...
                <div class="bg-gradient-to-br from-base-200/60 to-base-300/40 backdrop-blur-lg rounded-xl p-4 border border-primary/20">
                  <div class="text-center">
    ...
    <Modal :show="showRewardsModal" @close="closeRewardsModal" max-width="lg">
      <template #header>
        <div class="flex items-center gap-3">
          <div class="w-10 h-10 bg-gradient-to-br from-success/20 to-primary/20 rounded-xl flex items-center justify-center">
            <span class="text-2xl">🎉</span>
          </div>
          <div>
      ...
      <template #default>
        <div v-if="rewards" class="space-y-6">
          <div class="text-center p-6 bg-gradient-to-br from-success/10 to-primary/5 rounded-xl border border-success/20">
            <div class="w-16 h-16 bg-gradient-to-br from-success/20 to-primary/20 rounded-full flex items-center justify-center mx-auto mb-4">
              <span class="text-3xl">✨</span>
            </div>
            <h4 class="text-lg font-bold text-success mb-2">Récompenses obtenues !</h4>
            <p class="text-sm text-base-content/70">
              {{ totalRewards }} récompense{{ totalRewards > 1 ? 's' : '' }} ajoutée{{ totalRewards > 1 ? 's' : '' }} à votre compte
            </p>
          </div>

          <div class="grid grid-cols-1 gap-4">
            <div v-if="rewards.cash && rewards.cash > 0" class="bg-gradient-to-br from-base-100/80 to-base-200/60 backdrop-blur-sm rounded-xl p-4 border border-base-300/30">
            ...
            <div v-if="rewards.items && rewards.items.length > 0" class="space-y-3">
              ...
              <div v-for="item in rewards.items" :key="item.id" class="bg-gradient-to-br from-base-100/80 to-base-200/60 backdrop-blur-sm rounded-xl p-4 border border-base-300/30">
                <div class="flex items-center gap-4">
