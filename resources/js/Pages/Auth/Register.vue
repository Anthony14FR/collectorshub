    ...
    >
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                <Link
                    href="/"
                    class="text-3xl font-bold text-white hover:text-blue-300 transition-colors"
                >
                    CollectorsHub
                </Link>
                        ...
                        <div class="flex space-x-4">
                            ...
                            >
                                ...
                                <img
                                    :src="AVATAR_PATH(id)"
                                    :alt="`Avatar ${id}`"
                                    class="w-16 h-16 rounded-full border-4 transition-all duration-150"
                                    :class="
                                        form.avatar === AVATAR_PATH(id)
                                ...
                                <span
                                    ...
                                    class="text-xs text-blue-400 mt-1 font-bold"
                                    >Choisi</span
                                >
                            </label>
                        </div>
