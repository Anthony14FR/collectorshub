    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        ...
        <header class="relative">
            ...
            <nav class="relative z-10 flex items-center justify-between p-6 lg:px-8">
                <div class="flex lg:flex-1">
                    <Link href="/" class="text-2xl font-bold text-white hover:text-blue-300 transition-colors">
                    CollectorsHub
                    </Link>
                </div>

                <div class="flex items-center space-x-4">
                    <Link href="/me" class="text-white text-sm hover:text-blue-300 transition-colors">
                    ← Retour au profil
                    </Link>
                </div>
            </nav>
        ...
        <main class="relative z-10 mx-auto max-w-4xl px-6 py-12">
            ...
            <div class="text-center mb-8">
                <div
                    class="w-24 h-24 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                    <span class="text-white text-2xl font-bold">
                        {{ getUserInitial() }}
                    </span>
                </div>
                <h1 class="text-3xl font-bold text-white mb-2">Éditer mon profil</h1>
                <p class="text-gray-400">Modifiez vos informations personnelles</p>
            </div>
            ...
            <div class="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10 mb-8">
                ...
                <div v-if="!showProfileForm" class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="bg-gray-800/50 border border-gray-600 rounded-md p-3 text-white">
                            {{ auth.user.username }}
                        </div>
                    </div>
                ...
                <form v-if="showProfileForm" @submit.prevent="updateProfile" class="space-y-6">
                    <div class="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div v-if="profileForm.errors.username" class="mt-2 text-sm text-red-400">
                        ...
                        <div>
                            ...
                            <div v-if="profileForm.errors.email" class="mt-2 text-sm text-red-400">
            ...
            <div class="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10 mb-8">
                ...
                <div v-if="!showPasswordForm">
                    <p class="text-gray-400">
                        Votre mot de passe est sécurisé et chiffré. Cliquez sur "Changer le mot de passe" pour le
                        modifier.
                    </p>
                </div>

                <!-- Formulaire de changement de mot de passe -->
                <form v-if="showPasswordForm" @submit.prevent="updatePassword" class="space-y-6">
                    <div>
                        ...
                        <div v-if="passwordForm.errors.current_password" class="mt-2 text-sm text-red-400">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div v-if="passwordForm.errors.password" class="mt-2 text-sm text-red-400">
                        ...
                        <div>
                            ...
                            <div v-if="passwordForm.errors.password_confirmation" class="mt-2 text-sm text-red-400">
            ...
            <div class="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10">
                <h2 class="text-xl font-semibold text-white mb-6">Informations du compte</h2>
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <div class="bg-gray-800/50 border border-gray-600 rounded-md p-3">
                            <span :class="{
                                'bg-green-900/50 text-green-300 border-green-500': auth.user.status === 'active',
                                'bg-yellow-900/50 text-yellow-300 border-yellow-500': auth.user.status === 'suspended',
                                'bg-red-900/50 text-red-300 border-red-500': auth.user.status === 'banned'
                            }" class="inline-flex items-center px-3 py-1 rounded-full text-sm border">
                                {{ auth.user.status === 'active' ? '🟢 Actif' : auth.user.status === 'suspended'
                                    ? '🟡 Suspendu' : '🔴 Banni' }}
                            </span>
                        </div>
                    </div>
