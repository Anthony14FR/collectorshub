...
import { Zap, ArrowLeft, Edit, Save, Loader2, Info, RotateCcw, Home, Package, BarChart3, FileImage, Type, Shield, Eye } from 'lucide-vue-next';
                ...
                <div class="p-3 space-y-2">
                  <Link :href="`/admin/items/${item.id}`">
                    <Button variant="outline" size="sm" class="w-full justify-start">
                      <component :is="Eye" :size="16" class="mr-2" /> Voir l'item
                    </Button>
                  </Link>
                  ...
                  <Button @click="form = { name: item.name, description: item.description || '', type: item.type, effect: item.effect || {}, price: item.price, rarity: item.rarity, image: null }" variant="ghost" size="sm" class="w-full justify-start">
                ...
                <div class="flex-1 p-6 space-y-6 min-h-0 overflow-y-auto">
                  ...
                  <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                      ...
                      <div v-if="props.item.image" class="mb-2">
                        <img :src="props.item.image" alt="Image actuelle" class="w-16 h-16 object-cover rounded border" />
                        <p class="text-xs text-base-content/70 mt-1">Image actuelle</p>
                      </div>
                      <input
                        type="file"
                        accept="image/*"
