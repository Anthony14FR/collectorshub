          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label for="password" class="block text-sm font-medium text-gray-700 mb-2">
                Nouveau mot de passe <span class="text-gray-500 text-xs">(laisser vide pour ne pas
                  changer)</span>
              </label>
            ...
            <div>
              ...
              <input id="level" v-model.number="form.level" type="number" min="1" required
                     class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
              ...
              <input id="experience" v-model.number="form.experience" type="number" min="0" required
                     class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
              ...
              <input id="cash" v-model.number="form.cash" type="number" min="0" required
                     class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
