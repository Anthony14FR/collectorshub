...
import { Zap, ArrowLeft, Plus, Save, Loader2, Info, RotateCcw, Home, Map, BarChart3, DollarSign, Star, Circle, Sparkles, Gift, Target, Shield, X, CheckCircle, Clock, Users, Award } from 'lucide-vue-next';
      ...
      <div class="flex justify-center pt-6 mb-6">
        <div class="text-center">
          <h1 class="text-xl sm:text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent mb-1 tracking-wider flex items-center gap-2">
            <component :is="Plus" :size="28" class="inline align-middle mr-2" />
            CRÉER EXPÉDITION
          </h1>
              ...
              <div class="bg-base-100/60 backdrop-blur-sm rounded-xl border border-base-300/30 overflow-hidden">
                ...
                <div class="p-3 space-y-2">
                  <Button @click="submit" variant="primary" size="sm" class="w-full justify-start" :disabled="form.processing">
                    ...
                    {{ form.processing ? 'Création...' : 'Créer l\'expédition' }}
                  </Button>
              ...
              <div class="bg-base-100/60 backdrop-blur-sm rounded-xl border border-base-300/30 overflow-hidden">
                ...
                <div class="p-4 space-y-3">
                  <div class="text-xs text-base-content/70 leading-relaxed">
                    Créez une nouvelle expédition avec des récompenses et des prérequis personnalisés.
                  </div>
                  <div class="text-xs text-base-content/70 leading-relaxed">
                    Les expéditions peuvent être activées ou désactivées selon vos besoins.
                  </div>
                </div>
              </div>
